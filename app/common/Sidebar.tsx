...
const Sidebar = ({ show }: SidebarProps) => {
  return (
    <div className="flex flex-col ">
      <aside
        className={`fixed left-0 top-0 h-screen w-72 z-100 p-6 gap-6 flex flex-col bg-white transition-transform duration-300 ${
      ...
      >
        ...
        <Link href="/" className="flex gap-3 ml-9 ">
          ...
          <h1 className="text-[#4b5563] text-[16px] font-medium">Manage Team</h1>
        </Link>
      </aside>
    </div>
  );
